function [ms, behav, params] = SMART_generate_data_struct(AnimalDir, sessionNum, room, arena, params)
...
%     [ms, room, arena, params_sub] = behavior_DAT_tracking_file(ms, room_tracking_fname, arena_tracking_fname, params_sub);
    [ms, params_sub] = behavior_SMART_SLEAP_tracking(ms, room, arena, params);
    behav.room = room;
    behav.arena = arena;
