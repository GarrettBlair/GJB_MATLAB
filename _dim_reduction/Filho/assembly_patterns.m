...
% Modified by Daniel Almeida Filho, Oct,2019 (Normalize the assembly vector
% by its norm).
...
switch opts.Patterns.method
    ...
    case 'ICA'
        ...
        norms = sqrt(sum(AssemblyTemplates.^2));
        AssemblyTemplates = AssemblyTemplates./repmat(norms,size(AssemblyTemplates,1),1);
