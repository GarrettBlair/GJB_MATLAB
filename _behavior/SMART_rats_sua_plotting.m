...
vars2plot = {'entrpermin', 'metersran_per_min', 'probability_correct'}; 
names2plot = {'rewards/min', 'av speed (cm/sec)', 'prob. correct'}; 
ylims = {[0, 12], [0, 50], [.2, 1.0]};
